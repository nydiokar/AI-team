```yaml
job_id: AGENT_50_MANAGER_CONTEXT_FIDELITY
created_at: "2026-07-21T18:55:37+03:00"        # CANONICAL — set once at dispatch, never derive again
status: done              # ready | active | blocked | done | dead
owner: ""
depends_on: []
results_ref: DISPATCH_LOG.md             # -> DISPATCH_LOG.md section with the verdict prose
evidence: .ai/dispatch/AGENT_50_MANAGER_CONTEXT_FIDELITY.md                  # artifact paths that PROVE it ran (checked to exist)
updated_at: "2026-08-03T13:21:10.724183+00:00"
```
