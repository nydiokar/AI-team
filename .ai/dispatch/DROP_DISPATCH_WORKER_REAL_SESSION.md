```yaml
job_id: DROP_DISPATCH_WORKER_REAL_SESSION
...
evidence: .ai/dispatch/DROP_DISPATCH_WORKER_REAL_SESSION.md                  # artifact paths that PROVE it ran (checked to exist)
updated_at: "2026-08-03T13:21:13.084535+00:00"
```
