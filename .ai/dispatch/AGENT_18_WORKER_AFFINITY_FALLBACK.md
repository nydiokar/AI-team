```yaml
job_id: AGENT_18_WORKER_AFFINITY_FALLBACK
created_at: "2026-07-06T13:43:14+03:00"        # CANONICAL — set once at dispatch, never derive again
status: done              # ready | active | blocked | done | dead
owner: ""
depends_on: []
results_ref: DISPATCH_LOG.md             # -> DISPATCH_LOG.md section with the verdict prose
evidence: .ai/dispatch/AGENT_18_WORKER_AFFINITY_FALLBACK.md                  # artifact paths that PROVE it ran (checked to exist)
updated_at: "2026-08-03T13:21:04.118028+00:00"
```
