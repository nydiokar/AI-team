```yaml
job_id: AGENT_21_FLOW_SCHEMA_EXTENSION
...
evidence: .ai/dispatch/AGENT_21_FLOW_SCHEMA_EXTENSION.md                  # artifact paths that PROVE it ran (checked to exist)
updated_at: "2026-08-03T13:21:04.632754+00:00"
```
