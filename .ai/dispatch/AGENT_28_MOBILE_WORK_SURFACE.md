```yaml
job_id: AGENT_28_MOBILE_WORK_SURFACE
...
evidence: .ai/dispatch/AGENT_28_MOBILE_WORK_SURFACE.md                  # artifact paths that PROVE it ran (checked to exist)
updated_at: "2026-08-03T13:21:06.273069+00:00"
```
