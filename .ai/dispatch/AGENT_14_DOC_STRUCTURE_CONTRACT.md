```yaml
job_id: AGENT_14_DOC_STRUCTURE_CONTRACT
created_at: "2026-07-03T23:00:47+03:00"        # CANONICAL — set once at dispatch, never derive again
status: done              # ready | active | blocked | done | dead
owner: ""
depends_on: []
results_ref: DISPATCH_LOG.md             # -> DISPATCH_LOG.md section with the verdict prose
evidence: .ai/dispatch/AGENT_14_DOC_STRUCTURE_CONTRACT.md                  # artifact paths that PROVE it ran (checked to exist)
updated_at: "2026-08-03T13:21:02.509536+00:00"
```
