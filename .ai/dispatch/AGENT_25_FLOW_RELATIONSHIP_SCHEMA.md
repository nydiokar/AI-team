```yaml
job_id: AGENT_25_FLOW_RELATIONSHIP_SCHEMA
...
evidence: .ai/dispatch/AGENT_25_FLOW_RELATIONSHIP_SCHEMA.md                  # artifact paths that PROVE it ran (checked to exist)
updated_at: "2026-08-03T13:21:05.457341+00:00"
```
