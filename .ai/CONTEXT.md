...
| — | ~~PR #19 §7 gap: close worker sessions on Case-close~~ | Joined worker sessions lingered open after Case-close, holding a backend slot. | **MERGED** (PR #22, `main` 2026-07-17). `close_case` closes `case_role='worker'` sessions best-effort/isolated; 52 targeted tests green post-merge. |
