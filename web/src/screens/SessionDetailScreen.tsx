...
export function SessionDetailScreen() {
  ...
  // messages into a fresh session (any role: bare / worker / manager).
  ...
  // [Session-fork] Pending carry-over stashed for THIS session by a bare/worker fork
  // (consumed by the Composer on the first send). Surfaced as a visible banner so the
