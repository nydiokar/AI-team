...
EVENT_ATTRIBUTE_ALLOWLIST: Dict[str, frozenset[str]] = {
    ...
    "model.request.usage": frozenset({
        ...
        "counter_semantics", "context_window_tokens",
    }),
    "model.session_usage": frozenset({
        "input_tokens", "output_tokens", "cache_read_tokens",
        "cache_creation_tokens", "reasoning_tokens", "total_tokens",
        "context_window_tokens", "usage_source", "counter_semantics",
        ...
        "rate_limit_plan_type", "rate_limit_reached_type",
    }),
